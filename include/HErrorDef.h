...
/* Error codes concerning control and iconic variables 2460..
 * These error codes are mainly used by the engine when dealing with
 * dictionaries, if an unexpected type is encountered (for example,
 * "throw(MyDict.image)" if MyDict.image is an image, not a tuple).
 */
#define H_ERR_WT_CTRL_EXPECTED 2460 /* Type mismatch: Control expected, found iconic */
#define H_ERR_WT_ICONIC_EXPECTED 2461 /* Type mismatc: Iconic expected, control found */
...
#define H_ERR_NULL_PTR      6043 /* Function was given a NULL ptr as input */
...
/* DL */
#define H_ERR_DL_INTERNAL             7779 /* DL: Internal error */
...
/* DL Solver */
#define H_ERR_DL_SOLVER_INVALID_TYPE 7840 /* DL-Solver: Invalid type. */
#define H_ERR_DL_SOLVER_INVALID_UPDATE_FORMULA 7841 /* DL-Solver: Invalid update formula. */
...
/* Shape-based matching (without exclusively generic SBM) */
...
/* Generic Shape-based matching */
#define H_ERR_WGSMFV                    8670 /* The version of the shape model
                                                result is not supported */
#define H_ERR_GSM_INVALID_RES_SCALE     8671 /* Restrict scale parameter
                                                outside the trained range */
#define H_ERR_GSM_INVALID_ANGLE         8672 /* Angle parameter outside the
                                                trained range */
#define H_ERR_GSM_NEEDS_TRAINING        8673 /* Shape model needs training */
#define H_ERR_GSM_CONTRAST_HYS          8674 /* contrast_high cannot be smaller
                                                than contrast_low */
#define H_ERR_GSM_CONTRAST_MIN_CONTRAST 8675 /* Neither contrast_low nor
                                                contrast_high can be smaller
                                                than min_contrast */
#define H_ERR_GSM_ISO_SCALE_PAIR        8676 /* iso_scale_max cannot be smaller
                                                than iso_scale_min */
#define H_ERR_GSM_ANISO_SCALE_ROW       8677 /* scale_row_max cannot be smaller
                                                than scale_row_min */
#define H_ERR_GSM_ANISO_SCALE_COLUMN    8678 /* scale_column_max cannot be
                                                smaller than
                                                scale_column_min */
#define H_ERR_GSM_ISO_NOT_SET           8679 /* Isotropic scaling not set */
#define H_ERR_GSM_ANISO_NOT_SET         8680 /* Anisotropic scaling not set */
#define H_ERR_GSM_INVALID_METRIC_XLD    8681 /* No edge direction available to
                                                change shape matching metric */
