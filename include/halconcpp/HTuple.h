...
public:
  ...
  HTuple(const Hlong* l, Hlong num);
...
#  endif
  ...
  HTuple(const float* f, Hlong num);

  // Double precision floating point value
  HTuple(double d);

  // Double precision floating point array
  HTuple(const double* d, Hlong num);
...
HTuple         TupleTestEqualDictItem(const HTuple& keys);
