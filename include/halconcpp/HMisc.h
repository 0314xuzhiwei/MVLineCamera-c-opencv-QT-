...
public:
  ...
  static HTuple DistancePointLine(const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& Point1X, const HTuple& Point1Y, const HTuple& Point1Z, const HTuple& Point2X, const HTuple& Point2Y, const HTuple& Point2Z);

  // Calculate the distance between a 3D point and a 3D line given by two points on the line.
  static double DistancePointLine(double PointX, double PointY, double PointZ, double Point1X, double Point1Y, double Point1Z, double Point2X, double Point2Y, double Point2Z);

  // Calculate the distance between a 3D point and a 3D line given by Pluecker coordinates.
  static HTuple DistancePointPlueckerLine(const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ);

  // Calculate the distance between a 3D point and a 3D line given by Pluecker coordinates.
  static double DistancePointPlueckerLine(double PointX, double PointY, double PointZ, double LineDirectionX, double LineDirectionY, double LineDirectionZ, double LineMomentX, double LineMomentY, double LineMomentZ);

  // Convert a 3D line given by Pluecker coordinates to a 3D line given by a point and a direction.
  static void PlueckerLineToPointDirection(const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* PointX, HTuple* PointY, HTuple* PointZ, HTuple* DirectionX, HTuple* DirectionY, HTuple* DirectionZ);

  // Convert a 3D line given by Pluecker coordinates to a 3D line given by a point and a direction.
  static void PlueckerLineToPointDirection(double LineDirectionX, double LineDirectionY, double LineDirectionZ, double LineMomentX, double LineMomentY, double LineMomentZ, double* PointX, double* PointY, double* PointZ, double* DirectionX, double* DirectionY, double* DirectionZ);

  // Convert a 3D line given by Pluecker coordinates to a 3D line given by two points.
  static void PlueckerLineToPoints(const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* Point1X, HTuple* Point1Y, HTuple* Point1Z, HTuple* Point2X, HTuple* Point2Y, HTuple* Point2Z);

  // Convert a 3D line given by Pluecker coordinates to a 3D line given by two points.
  static void PlueckerLineToPoints(double LineDirectionX, double LineDirectionY, double LineDirectionZ, double LineMomentX, double LineMomentY, double LineMomentZ, double* Point1X, double* Point1Y, double* Point1Z, double* Point2X, double* Point2Y, double* Point2Z);

  // Convert a 3D line given by a point and a direction to Pluecker coordinates.
  static void PointDirectionToPlueckerLine(const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& DirectionX, const HTuple& DirectionY, const HTuple& DirectionZ, HTuple* LineDirectionX, HTuple* LineDirectionY, HTuple* LineDirectionZ, HTuple* LineMomentX, HTuple* LineMomentY, HTuple* LineMomentZ);

  // Convert a 3D line given by a point and a direction to Pluecker coordinates.
  static void PointDirectionToPlueckerLine(double PointX, double PointY, double PointZ, double DirectionX, double DirectionY, double DirectionZ, double* LineDirectionX, double* LineDirectionY, double* LineDirectionZ, double* LineMomentX, double* LineMomentY, double* LineMomentZ);

  // Convert a 3D line given by two points to Pluecker coordinates.
  static void PointsToPlueckerLine(const HTuple& Point1X, const HTuple& Point1Y, const HTuple& Point1Z, const HTuple& Point2X, const HTuple& Point2Y, const HTuple& Point2Z, HTuple* LineDirectionX, HTuple* LineDirectionY, HTuple* LineDirectionZ, HTuple* LineMomentX, HTuple* LineMomentY, HTuple* LineMomentZ);

  // Convert a 3D line given by two points to Pluecker coordinates.
  static void PointsToPlueckerLine(double Point1X, double Point1Y, double Point1Z, double Point2X, double Point2Y, double Point2Z, double* LineDirectionX, double* LineDirectionY, double* LineDirectionZ, double* LineMomentX, double* LineMomentY, double* LineMomentZ);
