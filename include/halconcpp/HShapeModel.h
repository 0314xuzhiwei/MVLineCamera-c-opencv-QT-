 ...
 *****************************************************************************/
  ...
  void CreateGenericShapeModel();

  // Find the best matches of one or multiple shape models in an image.
  static HGenericShapeModelResult FindGenericShapeModel(const HObject& SearchImage, const HShapeModelArray& ModelID, Hlong* NumMatchResult);

  // Find the best matches of one or multiple shape models in an image.
  HGenericShapeModelResult FindGenericShapeModel(const HObject& SearchImage, Hlong* NumMatchResult) const;

  // Return the parameters of a shape model.
  HTuple GetGenericShapeModelParam(const HTuple& GenParamName) const;

  // Set iconic objects to the shape model.
  void SetGenericShapeModelObject(const HObject& Object, const HTuple& GenParamName) const;

  // Set selected parameters of the shape model.
  void SetGenericShapeModelParam(const HTuple& GenParamName, const HTuple& GenParamValue) const;

  // Train a shape model for matching.
  void TrainGenericShapeModel(const HObject& Template) const;

  // Get iconic objects of the shape model.
  HObject GetGenericShapeModelObject(const HTuple& GenParamName) const;
...
public:
  ...
  HShapeModelArray(const HShapeModel* classes, Hlong length);
