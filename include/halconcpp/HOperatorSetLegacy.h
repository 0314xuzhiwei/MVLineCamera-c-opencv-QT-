...
LIntExport Herror create_dl_layer_activation(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& ActivationType, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerActivation);

LIntExport Herror create_dl_layer_batch_normalization(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Momentum, const HTuple& Epsilon, const HTuple& Activation, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerBatchNorm);

LIntExport Herror create_dl_layer_class_id_conversion(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& ConversionMode, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerClassIdConversion);

LIntExport Herror create_dl_layer_concat(const HTuple& DLLayerInputs, const HTuple& LayerName, const HTuple& Axis, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerConcat);

LIntExport Herror create_dl_layer_convolution(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& KernelSize, const HTuple& Dilation, const HTuple& Stride, const HTuple& NumKernel, const HTuple& Groups, const HTuple& Padding, const HTuple& Activation, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerConvolution);

LIntExport Herror create_dl_layer_dense(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& NumOut, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerDense);

LIntExport Herror create_dl_layer_depth_max(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& DepthMaxMode, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerDepthMaxArg, HTuple* DLLayerDepthMaxValue);

LIntExport Herror create_dl_layer_dropout(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Probability, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerDropOut);

LIntExport Herror create_dl_layer_elementwise(const HTuple& DLLayerInputs, const HTuple& LayerName, const HTuple& Operation, const HTuple& Coefficients, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerElementWise);

LIntExport Herror create_dl_layer_input(const HTuple& LayerName, const HTuple& Shape, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerInput);

LIntExport Herror create_dl_layer_loss_cross_entropy(const HTuple& DLLayerInput, const HTuple& DLLayerTarget, const HTuple& DLLayerWeights, const HTuple& LayerName, const HTuple& LossWeight, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossCrossEntropy);

LIntExport Herror create_dl_layer_loss_ctc(const HTuple& DLLayerInput, const HTuple& DLLayerInputLengths, const HTuple& DLLayerTarget, const HTuple& DLLayerTargetLengths, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossCTC);

LIntExport Herror create_dl_layer_loss_distance(const HTuple& DLLayerInput, const HTuple& DLLayerTarget, const HTuple& DLLayerWeights, const HTuple& LayerName, const HTuple& DistanceType, const HTuple& LossWeight, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossDistance);

LIntExport Herror create_dl_layer_loss_focal(const HTuple& DLLayerInput, const HTuple& DLLayerTarget, const HTuple& DLLayerWeights, const HTuple& DLLayerNormalization, const HTuple& LayerName, const HTuple& LossWeight, const HTuple& Gamma, const HTuple& ClassWeights, const HTuple& Type, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossFocal);

LIntExport Herror create_dl_layer_loss_huber(const HTuple& DLLayerInput, const HTuple& DLLayerTarget, const HTuple& DLLayerWeights, const HTuple& DLLayerNormalization, const HTuple& LayerName, const HTuple& LossWeight, const HTuple& Beta, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossHuber);

LIntExport Herror create_dl_layer_lrn(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& LocalSize, const HTuple& Alpha, const HTuple& Beta, const HTuple& K, const HTuple& NormRegion, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLRN);

LIntExport Herror create_dl_layer_pooling(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& KernelSize, const HTuple& Stride, const HTuple& Padding, const HTuple& Mode, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerPooling);

LIntExport Herror create_dl_layer_reshape(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Shape, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerReshape);

LIntExport Herror create_dl_layer_softmax(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerSoftMax);

LIntExport Herror create_dl_layer_transposed_convolution(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& KernelSize, const HTuple& Stride, const HTuple& KernelDepth, const HTuple& Groups, const HTuple& Padding, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerTransposedConvolution);

LIntExport Herror create_dl_layer_zoom_factor(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& ScaleWidth, const HTuple& ScaleHeight, const HTuple& Interpolation, const HTuple& AlignCorners, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerZoom);

LIntExport Herror create_dl_layer_zoom_size(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Width, const HTuple& Height, const HTuple& Interpolation, const HTuple& AlignCorners, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerZoom);

LIntExport Herror create_dl_layer_zoom_to_layer_size(const HTuple& DLLayerInput, const HTuple& DLLayerReference, const HTuple& LayerName, const HTuple& Interpolation, const HTuple& AlignCorners, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerZoom);

LIntExport Herror create_dl_model(const HTuple& OutputLayers, HTuple* DLModelHandle);

LIntExport Herror create_generic_shape_model(HTuple* ModelID);

LIntExport Herror find_generic_shape_model(const HObject& SearchImage, const HTuple& ModelID, HTuple* MatchResultID, HTuple* NumMatchResult);

LIntExport Herror get_dl_layer_param(const HTuple& DLLayer, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_dl_model_layer(const HTuple& DLModelHandle, const HTuple& LayerNames, HTuple* DLLayers);

LIntExport Herror get_dl_model_layer_activations(HObject* Activations, const HTuple& DLModelHandle, const HTuple& LayerName);

LIntExport Herror get_dl_model_layer_gradients(HObject* Gradients, const HTuple& DLModelHandle, const HTuple& LayerName);

LIntExport Herror get_dl_model_layer_param(const HTuple& DLModelHandle, const HTuple& LayerName, const HTuple& ParamName, HTuple* ParamValue);

LIntExport Herror get_dl_model_layer_weights(HObject* Weights, const HTuple& DLModelHandle, const HTuple& LayerName, const HTuple& WeightsType);

LIntExport Herror get_generic_shape_model_param(const HTuple& ModelID, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_generic_shape_model_result(const HTuple& MatchResultID, const HTuple& MatchSelector, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_generic_shape_model_result_object(HObject* Objects, const HTuple& MatchResultID, const HTuple& MatchSelector, const HTuple& GenParamName);

LIntExport Herror load_dl_model_weights(const HTuple& DLModelHandleSource, const HTuple& DLModelHandleTarget, HTuple* ChangesByLayer);

LIntExport Herror set_dl_model_layer_param(const HTuple& DLModelHandle, const HTuple& LayerName, const HTuple& ParamName, const HTuple& ParamValue);

LIntExport Herror set_dl_model_layer_weights(const HObject& Weights, const HTuple& DLModelHandle, const HTuple& LayerName, const HTuple& WeightsType);

LIntExport Herror set_generic_shape_model_object(const HObject& Object, const HTuple& ModelID, const HTuple& GenParamName);

LIntExport Herror set_generic_shape_model_param(const HTuple& ModelID, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror train_generic_shape_model(const HObject& Template, const HTuple& ModelID);

LIntExport Herror dict_to_json(const HTuple& DictHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* JsonString);

LIntExport Herror distance_point_line(const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& Point1X, const HTuple& Point1Y, const HTuple& Point1Z, const HTuple& Point2X, const HTuple& Point2Y, const HTuple& Point2Z, HTuple* Distance);

LIntExport Herror distance_point_pluecker_line(const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* Distance);

LIntExport Herror get_generic_shape_model_object(HObject* Object, const HTuple& ModelID, const HTuple& GenParamName);

LIntExport Herror json_to_dict(const HTuple& JsonString, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DictHandle);

LIntExport Herror pluecker_line_to_point_direction(const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* PointX, HTuple* PointY, HTuple* PointZ, HTuple* DirectionX, HTuple* DirectionY, HTuple* DirectionZ);

LIntExport Herror pluecker_line_to_points(const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* Point1X, HTuple* Point1Y, HTuple* Point1Z, HTuple* Point2X, HTuple* Point2Y, HTuple* Point2Z);

LIntExport Herror point_direction_to_pluecker_line(const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& DirectionX, const HTuple& DirectionY, const HTuple& DirectionZ, HTuple* LineDirectionX, HTuple* LineDirectionY, HTuple* LineDirectionZ, HTuple* LineMomentX, HTuple* LineMomentY, HTuple* LineMomentZ);

LIntExport Herror point_pluecker_line_to_hom_mat3d(const HTuple& TransformationType, const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* HomMat3D);

LIntExport Herror points_to_pluecker_line(const HTuple& Point1X, const HTuple& Point1Y, const HTuple& Point1Z, const HTuple& Point2X, const HTuple& Point2Y, const HTuple& Point2Z, HTuple* LineDirectionX, HTuple* LineDirectionY, HTuple* LineDirectionZ, HTuple* LineMomentX, HTuple* LineMomentY, HTuple* LineMomentZ);

LIntExport Herror set_dict_tuple_at(const HTuple& DictHandle, const HTuple& Key, const HTuple& Index, const HTuple& Value);
