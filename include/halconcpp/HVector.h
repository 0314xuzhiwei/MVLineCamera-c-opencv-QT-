...
public:
  ...
  explicit HTupleVector(Hlong dimension) : HVector(dimension) {}

  // Create leaf vector of dimension 0 for the specified tuple
  explicit HTupleVector(const HTuple& tuple) : HVector(0), mTuple(tuple) {}
...
public:
  ...
  explicit HObjectVector(const HObject& obj) : HVector(0), mObject(obj) {}
