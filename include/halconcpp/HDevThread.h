...
public:
  ...
  explicit HDevThread(const HDevThreadContext& context, const void* proc,
                      Hlong num_in, Hlong num_out);
  ~HDevThread();
  ...
  void SetInputIconicParamVector(Hlong par_index, const HObjectVector& vector);
  void SetInputCtrlParamTuple(Hlong par_index, const HTuple& tuple);
  void SetInputCtrlParamVector(Hlong par_index, const HTupleVector& vector);
  ...
  void BindOutputIconicParamObject(Hlong par_index, bool global, HObject* obj);
  ...
  void StoreOutputCtrlParamVector(Hlong par_index, const HTupleVector& vector);
