...
LIntExport void CreateDlLayerActivation(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& ActivationType, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerActivation);

// Create a batch normalization layer.
LIntExport void CreateDlLayerBatchNormalization(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Momentum, const HTuple& Epsilon, const HTuple& Activation, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerBatchNorm);

// Create a class ID conversion layer.
LIntExport void CreateDlLayerClassIdConversion(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& ConversionMode, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerClassIdConversion);

// Create a concatenation layer.
LIntExport void CreateDlLayerConcat(const HTuple& DLLayerInputs, const HTuple& LayerName, const HTuple& Axis, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerConcat);

// Create a convolutional layer.
LIntExport void CreateDlLayerConvolution(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& KernelSize, const HTuple& Dilation, const HTuple& Stride, const HTuple& NumKernel, const HTuple& Groups, const HTuple& Padding, const HTuple& Activation, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerConvolution);

// Create a dense layer.
LIntExport void CreateDlLayerDense(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& NumOut, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerDense);

// Create a depth max layer.
LIntExport void CreateDlLayerDepthMax(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& DepthMaxMode, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerDepthMaxArg, HTuple* DLLayerDepthMaxValue);

// Create a DropOut layer.
LIntExport void CreateDlLayerDropout(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Probability, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerDropOut);

// Create an elementwise layer.
LIntExport void CreateDlLayerElementwise(const HTuple& DLLayerInputs, const HTuple& LayerName, const HTuple& Operation, const HTuple& Coefficients, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerElementWise);

// Create an input layer.
LIntExport void CreateDlLayerInput(const HTuple& LayerName, const HTuple& Shape, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerInput);

// Create a cross entropy loss layer.
LIntExport void CreateDlLayerLossCrossEntropy(const HTuple& DLLayerInput, const HTuple& DLLayerTarget, const HTuple& DLLayerWeights, const HTuple& LayerName, const HTuple& LossWeight, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossCrossEntropy);

// Create a CTC loss layer.
LIntExport void CreateDlLayerLossCtc(const HTuple& DLLayerInput, const HTuple& DLLayerInputLengths, const HTuple& DLLayerTarget, const HTuple& DLLayerTargetLengths, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossCTC);

// Create a distance loss layer.
LIntExport void CreateDlLayerLossDistance(const HTuple& DLLayerInput, const HTuple& DLLayerTarget, const HTuple& DLLayerWeights, const HTuple& LayerName, const HTuple& DistanceType, const HTuple& LossWeight, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossDistance);

// Create a focal loss layer.
LIntExport void CreateDlLayerLossFocal(const HTuple& DLLayerInput, const HTuple& DLLayerTarget, const HTuple& DLLayerWeights, const HTuple& DLLayerNormalization, const HTuple& LayerName, const HTuple& LossWeight, const HTuple& Gamma, const HTuple& ClassWeights, const HTuple& Type, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossFocal);

// Create a Huber loss layer.
LIntExport void CreateDlLayerLossHuber(const HTuple& DLLayerInput, const HTuple& DLLayerTarget, const HTuple& DLLayerWeights, const HTuple& DLLayerNormalization, const HTuple& LayerName, const HTuple& LossWeight, const HTuple& Beta, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLossHuber);

// Create a LRN layer.
LIntExport void CreateDlLayerLrn(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& LocalSize, const HTuple& Alpha, const HTuple& Beta, const HTuple& K, const HTuple& NormRegion, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerLRN);

// Create a pooling layer.
LIntExport void CreateDlLayerPooling(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& KernelSize, const HTuple& Stride, const HTuple& Padding, const HTuple& Mode, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerPooling);

// Create a reshape layer.
LIntExport void CreateDlLayerReshape(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Shape, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerReshape);

// Create a softmax layer.
LIntExport void CreateDlLayerSoftmax(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerSoftMax);

// Create a transposed convolution layer.
LIntExport void CreateDlLayerTransposedConvolution(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& KernelSize, const HTuple& Stride, const HTuple& KernelDepth, const HTuple& Groups, const HTuple& Padding, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerTransposedConvolution);

// Create a zoom layer using size factors.
LIntExport void CreateDlLayerZoomFactor(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& ScaleWidth, const HTuple& ScaleHeight, const HTuple& Interpolation, const HTuple& AlignCorners, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerZoom);

// Create a zoom layer using an absolute output size.
LIntExport void CreateDlLayerZoomSize(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Width, const HTuple& Height, const HTuple& Interpolation, const HTuple& AlignCorners, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerZoom);

// Create a zoom layer using the output size of a reference layer.
LIntExport void CreateDlLayerZoomToLayerSize(const HTuple& DLLayerInput, const HTuple& DLLayerReference, const HTuple& LayerName, const HTuple& Interpolation, const HTuple& AlignCorners, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerZoom);

// Create a deep learning model.
LIntExport void CreateDlModel(const HTuple& OutputLayers, HTuple* DLModelHandle);

// Create a shape model.
LIntExport void CreateGenericShapeModel(HTuple* ModelID);

// Find the best matches of one or multiple shape models in an image.
LIntExport void FindGenericShapeModel(const HObject& SearchImage, const HTuple& ModelID, HTuple* MatchResultID, HTuple* NumMatchResult);

// Return the parameters of a deep learning layer.
LIntExport void GetDlLayerParam(const HTuple& DLLayer, const HTuple& GenParamName, HTuple* GenParamValue);

// Create a deep copy of the layers and all  of their graph ancestors in a given deep learning model.
LIntExport void GetDlModelLayer(const HTuple& DLModelHandle, const HTuple& LayerNames, HTuple* DLLayers);

// Get the activations of a Deep Learning model layer.
LIntExport void GetDlModelLayerActivations(HObject* Activations, const HTuple& DLModelHandle, const HTuple& LayerName);

// Get the gradients of a Deep Learning model layer.
LIntExport void GetDlModelLayerGradients(HObject* Gradients, const HTuple& DLModelHandle, const HTuple& LayerName);

// Retrieve parameter values for a given layer.
LIntExport void GetDlModelLayerParam(const HTuple& DLModelHandle, const HTuple& LayerName, const HTuple& ParamName, HTuple* ParamValue);

// Get the weights (or values) of a Deep Learning model layer.
LIntExport void GetDlModelLayerWeights(HObject* Weights, const HTuple& DLModelHandle, const HTuple& LayerName, const HTuple& WeightsType);

// Return the parameters of a shape model.
LIntExport void GetGenericShapeModelParam(const HTuple& ModelID, const HTuple& GenParamName, HTuple* GenParamValue);

// Get alphanumerical values from a shape matching result.
LIntExport void GetGenericShapeModelResult(const HTuple& MatchResultID, const HTuple& MatchSelector, const HTuple& GenParamName, HTuple* GenParamValue);

// Get objects from a shape matching result.
LIntExport void GetGenericShapeModelResultObject(HObject* Objects, const HTuple& MatchResultID, const HTuple& MatchSelector, const HTuple& GenParamName);

// Load the weights of a source model into a target model.
LIntExport void LoadDlModelWeights(const HTuple& DLModelHandleSource, const HTuple& DLModelHandleTarget, HTuple* ChangesByLayer);

// Set parameter values of a given layer.
LIntExport void SetDlModelLayerParam(const HTuple& DLModelHandle, const HTuple& LayerName, const HTuple& ParamName, const HTuple& ParamValue);

// Set the weights (or values) of a Deep Learning model layer.
LIntExport void SetDlModelLayerWeights(const HObject& Weights, const HTuple& DLModelHandle, const HTuple& LayerName, const HTuple& WeightsType);

// Set iconic objects to the shape model.
LIntExport void SetGenericShapeModelObject(const HObject& Object, const HTuple& ModelID, const HTuple& GenParamName);

// Set selected parameters of the shape model.
LIntExport void SetGenericShapeModelParam(const HTuple& ModelID, const HTuple& GenParamName, const HTuple& GenParamValue);

// Train a shape model for matching.
LIntExport void TrainGenericShapeModel(const HObject& Template, const HTuple& ModelID);

// Transform a dictionary into a JSON string.
LIntExport void DictToJson(const HTuple& DictHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* JsonString);

// Calculate the distance between a 3D point and a 3D line given by two points on the line.
LIntExport void DistancePointLine(const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& Point1X, const HTuple& Point1Y, const HTuple& Point1Z, const HTuple& Point2X, const HTuple& Point2Y, const HTuple& Point2Z, HTuple* Distance);

// Calculate the distance between a 3D point and a 3D line given by Pluecker coordinates.
LIntExport void DistancePointPlueckerLine(const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* Distance);

// Get iconic objects of the shape model.
LIntExport void GetGenericShapeModelObject(HObject* Object, const HTuple& ModelID, const HTuple& GenParamName);

// Transform a JSON string into a dictionary.
LIntExport void JsonToDict(const HTuple& JsonString, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DictHandle);

// Convert a 3D line given by Pluecker coordinates to a 3D line given by a point and a direction.
LIntExport void PlueckerLineToPointDirection(const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* PointX, HTuple* PointY, HTuple* PointZ, HTuple* DirectionX, HTuple* DirectionY, HTuple* DirectionZ);

// Convert a 3D line given by Pluecker coordinates to a 3D line given by two points.
LIntExport void PlueckerLineToPoints(const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* Point1X, HTuple* Point1Y, HTuple* Point1Z, HTuple* Point2X, HTuple* Point2Y, HTuple* Point2Z);

// Convert a 3D line given by a point and a direction to Pluecker coordinates.
LIntExport void PointDirectionToPlueckerLine(const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& DirectionX, const HTuple& DirectionY, const HTuple& DirectionZ, HTuple* LineDirectionX, HTuple* LineDirectionY, HTuple* LineDirectionZ, HTuple* LineMomentX, HTuple* LineMomentY, HTuple* LineMomentZ);

// Approximate a 3D affine transformation from 3D point-to-line correspondences.
LIntExport void PointPlueckerLineToHomMat3d(const HTuple& TransformationType, const HTuple& PointX, const HTuple& PointY, const HTuple& PointZ, const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentX, const HTuple& LineMomentY, const HTuple& LineMomentZ, HTuple* HomMat3D);

// Convert a 3D line given by two points to Pluecker coordinates.
LIntExport void PointsToPlueckerLine(const HTuple& Point1X, const HTuple& Point1Y, const HTuple& Point1Z, const HTuple& Point2X, const HTuple& Point2Y, const HTuple& Point2Z, HTuple* LineDirectionX, HTuple* LineDirectionY, HTuple* LineDirectionZ, HTuple* LineMomentX, HTuple* LineMomentY, HTuple* LineMomentZ);

// Assignment of one or several values to one or several tuple elements in a dictionary
LIntExport void SetDictTupleAt(const HTuple& DictHandle, const HTuple& Key, const HTuple& Index, const HTuple& Value);
