 ...
 *****************************************************************************/
  ...
  static HTuple DictToJson(const HDictArray& DictHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

  // Transform a dictionary into a JSON string.
  HString DictToJson(const HString& GenParamName, const HString& GenParamValue) const;

  // Transform a dictionary into a JSON string.
  HString DictToJson(const char* GenParamName, const char* GenParamValue) const;

#ifdef _WIN32
  // Transform a dictionary into a JSON string.
  HString DictToJson(const wchar_t* GenParamName, const wchar_t* GenParamValue) const;
#endif

  // Transform a JSON string into a dictionary.
  static HDictArray JsonToDict(const HTuple& JsonString, const HTuple& GenParamName, const HTuple& GenParamValue);

  // Transform a JSON string into a dictionary.
  void JsonToDict(const HString& JsonString, const HString& GenParamName, const HString& GenParamValue);

  // Transform a JSON string into a dictionary.
  void JsonToDict(const char* JsonString, const char* GenParamName, const char* GenParamValue);

#ifdef _WIN32
  // Transform a JSON string into a dictionary.
  void JsonToDict(const wchar_t* JsonString, const wchar_t* GenParamName, const wchar_t* GenParamValue);
#endif

  // Assignment of one or several values to one or several tuple elements in a dictionary
  void SetDictTupleAt(const HTuple& Key, const HTuple& Index, const HTuple& Value) const;

  // Assignment of one or several values to one or several tuple elements in a dictionary
  void SetDictTupleAt(const HString& Key, const HTuple& Index, const HTuple& Value) const;

  // Assignment of one or several values to one or several tuple elements in a dictionary
  void SetDictTupleAt(const char* Key, const HTuple& Index, const HTuple& Value) const;

#ifdef _WIN32
  // Assignment of one or several values to one or several tuple elements in a dictionary
  void SetDictTupleAt(const wchar_t* Key, const HTuple& Index, const HTuple& Value) const;
#endif
...
public:
  ...
  HDictArray(const HDict* classes, Hlong length);
