...
HTuple Height() const;
  ...
  HGenericShapeModelResult FindGenericShapeModel(const HShapeModelArray& ModelID, Hlong* NumMatchResult) const;

  // Find the best matches of one or multiple shape models in an image.
  HGenericShapeModelResult FindGenericShapeModel(const HShapeModel& ModelID, Hlong* NumMatchResult) const;

  // Train a shape model for matching.
  void TrainGenericShapeModel(const HShapeModel& ModelID) const;
