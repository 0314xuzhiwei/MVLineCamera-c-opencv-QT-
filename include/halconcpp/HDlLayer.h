 ...
 *****************************************************************************/
  ...
  HDlLayer CreateDlLayerTransposedConvolution(const HString& LayerName, Hlong KernelSize, Hlong Stride, Hlong KernelDepth, Hlong Groups, const HString& Padding, const HTuple& GenParamName, const HTuple& GenParamValue) const;
