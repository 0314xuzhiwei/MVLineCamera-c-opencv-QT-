...
#define OCR_TRAINFILE_VERSION3_0 3 /* trainf + uint16_t images */
...
#define H_ENCODING_ASCII                                                      \
  4 /* promise that a passed string is                                        \
     * pure ASCII                      */
#define H_ENCODING_SYSTEM                                                     \
  5 /* promise that a passed string is                                        \
     * in system encoding: which is the                                       \
     * locale under Linux, utf8 on Mac,                                       \
     * and for Windows not needed      */
#define H_ENCODING_AUTO                                                       \
  6 /* generic mode for detecting the                                         \
     * encoding automatically */
#define H_ENCODING_LATIN1                                                     \
  7 /* promise that a passed string is                                        \
       pure latin-1 */
