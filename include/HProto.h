...
LIntExport Herror T_create_dl_layer_activation(const Htuple DLLayerInput, const Htuple LayerName, const Htuple ActivationType, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerActivation);
LIntExport Herror T_create_dl_layer_batch_normalization(const Htuple DLLayerInput, const Htuple LayerName, const Htuple Momentum, const Htuple Epsilon, const Htuple Activation, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerBatchNorm);
LIntExport Herror T_create_dl_layer_class_id_conversion(const Htuple DLLayerInput, const Htuple LayerName, const Htuple ConversionMode, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerClassIdConversion);
LIntExport Herror T_create_dl_layer_concat(const Htuple DLLayerInputs, const Htuple LayerName, const Htuple Axis, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerConcat);
LIntExport Herror T_create_dl_layer_convolution(const Htuple DLLayerInput, const Htuple LayerName, const Htuple KernelSize, const Htuple Dilation, const Htuple Stride, const Htuple NumKernel, const Htuple Groups, const Htuple Padding, const Htuple Activation, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerConvolution);
LIntExport Herror T_create_dl_layer_dense(const Htuple DLLayerInput, const Htuple LayerName, const Htuple NumOut, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerDense);
LIntExport Herror T_create_dl_layer_depth_max(const Htuple DLLayerInput, const Htuple LayerName, const Htuple DepthMaxMode, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerDepthMaxArg, Htuple *DLLayerDepthMaxValue);
LIntExport Herror T_create_dl_layer_dropout(const Htuple DLLayerInput, const Htuple LayerName, const Htuple Probability, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerDropOut);
LIntExport Herror T_create_dl_layer_elementwise(const Htuple DLLayerInputs, const Htuple LayerName, const Htuple Operation, const Htuple Coefficients, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerElementWise);
LIntExport Herror T_create_dl_layer_input(const Htuple LayerName, const Htuple Shape, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerInput);
LIntExport Herror T_create_dl_layer_loss_cross_entropy(const Htuple DLLayerInput, const Htuple DLLayerTarget, const Htuple DLLayerWeights, const Htuple LayerName, const Htuple LossWeight, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerLossCrossEntropy);
LIntExport Herror T_create_dl_layer_loss_ctc(const Htuple DLLayerInput, const Htuple DLLayerInputLengths, const Htuple DLLayerTarget, const Htuple DLLayerTargetLengths, const Htuple LayerName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerLossCTC);
LIntExport Herror T_create_dl_layer_loss_distance(const Htuple DLLayerInput, const Htuple DLLayerTarget, const Htuple DLLayerWeights, const Htuple LayerName, const Htuple DistanceType, const Htuple LossWeight, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerLossDistance);
LIntExport Herror T_create_dl_layer_loss_focal(const Htuple DLLayerInput, const Htuple DLLayerTarget, const Htuple DLLayerWeights, const Htuple DLLayerNormalization, const Htuple LayerName, const Htuple LossWeight, const Htuple Gamma, const Htuple ClassWeights, const Htuple Type, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerLossFocal);
LIntExport Herror T_create_dl_layer_loss_huber(const Htuple DLLayerInput, const Htuple DLLayerTarget, const Htuple DLLayerWeights, const Htuple DLLayerNormalization, const Htuple LayerName, const Htuple LossWeight, const Htuple Beta, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerLossHuber);
LIntExport Herror T_create_dl_layer_lrn(const Htuple DLLayerInput, const Htuple LayerName, const Htuple LocalSize, const Htuple Alpha, const Htuple Beta, const Htuple K, const Htuple NormRegion, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerLRN);
LIntExport Herror T_create_dl_layer_pooling(const Htuple DLLayerInput, const Htuple LayerName, const Htuple KernelSize, const Htuple Stride, const Htuple Padding, const Htuple Mode, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerPooling);
LIntExport Herror T_create_dl_layer_reshape(const Htuple DLLayerInput, const Htuple LayerName, const Htuple Shape, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerReshape);
LIntExport Herror T_create_dl_layer_softmax(const Htuple DLLayerInput, const Htuple LayerName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerSoftMax);
LIntExport Herror T_create_dl_layer_transposed_convolution(const Htuple DLLayerInput, const Htuple LayerName, const Htuple KernelSize, const Htuple Stride, const Htuple KernelDepth, const Htuple Groups, const Htuple Padding, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerTransposedConvolution);
LIntExport Herror T_create_dl_layer_zoom_factor(const Htuple DLLayerInput, const Htuple LayerName, const Htuple ScaleWidth, const Htuple ScaleHeight, const Htuple Interpolation, const Htuple AlignCorners, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerZoom);
LIntExport Herror T_create_dl_layer_zoom_size(const Htuple DLLayerInput, const Htuple LayerName, const Htuple Width, const Htuple Height, const Htuple Interpolation, const Htuple AlignCorners, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerZoom);
LIntExport Herror T_create_dl_layer_zoom_to_layer_size(const Htuple DLLayerInput, const Htuple DLLayerReference, const Htuple LayerName, const Htuple Interpolation, const Htuple AlignCorners, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerZoom);
LIntExport Herror T_create_dl_model(const Htuple OutputLayers, Htuple *DLModelHandle);
LIntExport Herror T_create_generic_shape_model(Htuple *ModelID);
LIntExport Herror T_find_generic_shape_model(const Hobject SearchImage, const Htuple ModelID, Htuple *MatchResultID, Htuple *NumMatchResult);
LIntExport Herror T_get_dl_layer_param(const Htuple DLLayer, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_get_dl_model_layer(const Htuple DLModelHandle, const Htuple LayerNames, Htuple *DLLayers);
LIntExport Herror T_get_dl_model_layer_activations(Hobject *Activations, const Htuple DLModelHandle, const Htuple LayerName);
LIntExport Herror T_get_dl_model_layer_gradients(Hobject *Gradients, const Htuple DLModelHandle, const Htuple LayerName);
LIntExport Herror T_get_dl_model_layer_param(const Htuple DLModelHandle, const Htuple LayerName, const Htuple ParamName, Htuple *ParamValue);
LIntExport Herror T_get_dl_model_layer_weights(Hobject *Weights, const Htuple DLModelHandle, const Htuple LayerName, const Htuple WeightsType);
LIntExport Herror T_get_generic_shape_model_param(const Htuple ModelID, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_get_generic_shape_model_result(const Htuple MatchResultID, const Htuple MatchSelector, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_get_generic_shape_model_result_object(Hobject *Objects, const Htuple MatchResultID, const Htuple MatchSelector, const Htuple GenParamName);
LIntExport Herror T_load_dl_model_weights(const Htuple DLModelHandleSource, const Htuple DLModelHandleTarget, Htuple *ChangesByLayer);
LIntExport Herror T_set_dl_model_layer_param(const Htuple DLModelHandle, const Htuple LayerName, const Htuple ParamName, const Htuple ParamValue);
LIntExport Herror T_set_dl_model_layer_weights(const Hobject Weights, const Htuple DLModelHandle, const Htuple LayerName, const Htuple WeightsType);
LIntExport Herror T_set_generic_shape_model_object(const Hobject Object, const Htuple ModelID, const Htuple GenParamName);
LIntExport Herror T_set_generic_shape_model_param(const Htuple ModelID, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_train_generic_shape_model(const Hobject Template, const Htuple ModelID);
LIntExport Herror T_dict_to_json(const Htuple DictHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *JsonString);
LIntExport Herror T_distance_point_line(const Htuple PointX, const Htuple PointY, const Htuple PointZ, const Htuple Point1X, const Htuple Point1Y, const Htuple Point1Z, const Htuple Point2X, const Htuple Point2Y, const Htuple Point2Z, Htuple *Distance);
LIntExport Herror distance_point_line(double PointX, double PointY, double PointZ, double Point1X, double Point1Y, double Point1Z, double Point2X, double Point2Y, double Point2Z, double *Distance);
LIntExport Herror T_distance_point_pluecker_line(const Htuple PointX, const Htuple PointY, const Htuple PointZ, const Htuple LineDirectionX, const Htuple LineDirectionY, const Htuple LineDirectionZ, const Htuple LineMomentX, const Htuple LineMomentY, const Htuple LineMomentZ, Htuple *Distance);
LIntExport Herror distance_point_pluecker_line(double PointX, double PointY, double PointZ, double LineDirectionX, double LineDirectionY, double LineDirectionZ, double LineMomentX, double LineMomentY, double LineMomentZ, double *Distance);
LIntExport Herror T_get_generic_shape_model_object(Hobject *Object, const Htuple ModelID, const Htuple GenParamName);
LIntExport Herror T_json_to_dict(const Htuple JsonString, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DictHandle);
LIntExport Herror T_pluecker_line_to_point_direction(const Htuple LineDirectionX, const Htuple LineDirectionY, const Htuple LineDirectionZ, const Htuple LineMomentX, const Htuple LineMomentY, const Htuple LineMomentZ, Htuple *PointX, Htuple *PointY, Htuple *PointZ, Htuple *DirectionX, Htuple *DirectionY, Htuple *DirectionZ);
LIntExport Herror pluecker_line_to_point_direction(double LineDirectionX, double LineDirectionY, double LineDirectionZ, double LineMomentX, double LineMomentY, double LineMomentZ, double *PointX, double *PointY, double *PointZ, double *DirectionX, double *DirectionY, double *DirectionZ);
LIntExport Herror T_pluecker_line_to_points(const Htuple LineDirectionX, const Htuple LineDirectionY, const Htuple LineDirectionZ, const Htuple LineMomentX, const Htuple LineMomentY, const Htuple LineMomentZ, Htuple *Point1X, Htuple *Point1Y, Htuple *Point1Z, Htuple *Point2X, Htuple *Point2Y, Htuple *Point2Z);
LIntExport Herror pluecker_line_to_points(double LineDirectionX, double LineDirectionY, double LineDirectionZ, double LineMomentX, double LineMomentY, double LineMomentZ, double *Point1X, double *Point1Y, double *Point1Z, double *Point2X, double *Point2Y, double *Point2Z);
LIntExport Herror T_point_direction_to_pluecker_line(const Htuple PointX, const Htuple PointY, const Htuple PointZ, const Htuple DirectionX, const Htuple DirectionY, const Htuple DirectionZ, Htuple *LineDirectionX, Htuple *LineDirectionY, Htuple *LineDirectionZ, Htuple *LineMomentX, Htuple *LineMomentY, Htuple *LineMomentZ);
LIntExport Herror point_direction_to_pluecker_line(double PointX, double PointY, double PointZ, double DirectionX, double DirectionY, double DirectionZ, double *LineDirectionX, double *LineDirectionY, double *LineDirectionZ, double *LineMomentX, double *LineMomentY, double *LineMomentZ);
LIntExport Herror T_point_pluecker_line_to_hom_mat3d(const Htuple TransformationType, const Htuple PointX, const Htuple PointY, const Htuple PointZ, const Htuple LineDirectionX, const Htuple LineDirectionY, const Htuple LineDirectionZ, const Htuple LineMomentX, const Htuple LineMomentY, const Htuple LineMomentZ, Htuple *HomMat3D);
LIntExport Herror T_points_to_pluecker_line(const Htuple Point1X, const Htuple Point1Y, const Htuple Point1Z, const Htuple Point2X, const Htuple Point2Y, const Htuple Point2Z, Htuple *LineDirectionX, Htuple *LineDirectionY, Htuple *LineDirectionZ, Htuple *LineMomentX, Htuple *LineMomentY, Htuple *LineMomentZ);
LIntExport Herror points_to_pluecker_line(double Point1X, double Point1Y, double Point1Z, double Point2X, double Point2Y, double Point2Z, double *LineDirectionX, double *LineDirectionY, double *LineDirectionZ, double *LineMomentX, double *LineMomentY, double *LineMomentZ);
LIntExport Herror T_set_dict_tuple_at(const Htuple DictHandle, const Htuple Key, const Htuple Index, const Htuple Value);
