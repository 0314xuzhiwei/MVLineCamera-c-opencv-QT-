...
#define HAG_PAR_INDEPENDENT                                                   \
  0                                /* completely independent of other         \
...
#define HAG_PAR_FORCE                                                         \
  (1 << 1)                    /* force parallelization if                     \
                               * supported */
...
#define HAG_PAR_PART                                                          \
  (1 << 9)                     /* partial automatic parallelization:          \
...
#define HAG_PAR_ALL                                                           \
  (HAG_PAR_TUPL | HAG_PAR_CHNL | HAG_PAR_RESC | HAG_PAR_REIF | HAG_PAR_PART | \
   HAG_PAR_PAIF)
...
#define HAG_PAR_DPAR_MT                                                       \
  (HAG_PAR_TUPL_MT | HAG_PAR_CHNL_MT | HAG_PAR_RESC_MT | HAG_PAR_REIF_MT |    \
